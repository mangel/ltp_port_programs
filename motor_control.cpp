...
#define MOTOR_1_TURN_R_OPTION 1
#define MOTOR_1_TURN_L_OPTION 2
#define MOTOR_2_TURN_R_OPTION 3
#define MOTOR_2_TURN_L_OPTION 4
#define MOTOR_3_TURN_R_OPTION 5
#define MOTOR_3_TURN_L_OPTION 6
#define MOTORS_1_2_3_TURN_R_OPTION 7
#define MOTORS_1_2_3_TURN_L_OPTION 8
#define STOP_MOTORS_OPTION 9
#define EXIT_OPTION 10

#define OPTIONS_RANGE_BEGIN 1
#define OPTIONS_RANGE_END 10
